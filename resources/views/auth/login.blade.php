    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control rounded-3 py-2 px-3" required autofocus placeholder="e.g. admin@company.com">
            </div>
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center fs-7">
                <div class="form-check">
                    <input type="checkbox" name="remember" class="form-check-input" id="remember">
                    <label class="form-check-label text-muted" for="remember">Remember me</label>
                </div>
                <a href="{{ route('password.request') }}" class="text-decoration-none text-muted fw-semibold" style="font-size:13px;">Forgot password?</a>
            </div>
