        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link active text-dark fw-bold" href="{{ route('for.consultants') }}">For Consultants</a></li>
                    <li class="nav-item"><a class="nav-link text-muted" href="{{ route('for.small-business') }}">Small Business</a></li>
