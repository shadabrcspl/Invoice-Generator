        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link text-muted" href="{{ route('templates.word') }}">Word Templates</a></li>
                    <li class="nav-item"><a class="nav-link active text-dark fw-bold" href="{{ route('templates.excel') }}">Excel Templates</a></li>
