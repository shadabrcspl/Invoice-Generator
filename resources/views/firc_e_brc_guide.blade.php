        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link text-muted" href="{{ route('guide.gst-lut') }}">LUT Guide</a></li>
                    <li class="nav-item"><a class="nav-link active text-dark fw-bold" href="{{ route('guide.firc-e-brc') }}">FIRC & e-BRC Guide</a></li>
