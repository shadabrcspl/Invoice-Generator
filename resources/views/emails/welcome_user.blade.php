...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4f8;padding:40px 0;">
  <tr><td align="center">
    <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      <tr>
        <td style="background:linear-gradient(135deg,#1e3a5f,#2d6cdf);padding:40px;text-align:center;">
          ...
          <h1 style="margin:0;color:#ffffff;font-size:26px;font-weight:800;">Welcome Aboard!</h1>
          <p style="margin:8px 0 0;color:rgba(255,255,255,0.8);font-size:14px;">Your account has been created successfully</p>
        </td>
      </tr>
      <tr>
        <td style="padding:36px 40px;">
          <p style="margin:0 0 20px;color:#374151;font-size:15px;">Hello <strong>{{ $user->name }}</strong>,</p>
          <p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.7;">Your account on <strong>{{ config('app.name') }}</strong> has been created. You can now log in and start managing your invoices, clients, and company settings.</p>
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;margin-bottom:28px;">
            <tr><td style="padding:20px 24px;">
              <p style="margin:0 0 10px;color:#9ca3af;font-size:11px;text-transform:uppercase;letter-spacing:1px;">Your Account Details</p>
              ...
              <p style="margin:0;color:#374151;font-size:13px;"><span style="color:#9ca3af;">Login URL:</span> <a href="{{ config('app.url') }}/login" style="color:#2d6cdf;">{{ config('app.url') }}/login</a></p>
            </td></tr>
          </table>
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center">
              <a href="{{ config('app.url') }}/login" style="display:inline-block;background:linear-gradient(135deg,#2d6cdf,#1e3a5f);color:#ffffff;text-decoration:none;padding:14px 36px;border-radius:8px;font-size:14px;font-weight:600;">Login to Your Account →</a>
            </td></tr>
          </table>
        </td>
      </tr>
