    ...
    <table width="640" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="background:#f8fafc;padding:24px 40px;text-align:center;border-top:1px solid #e2e8f0;">
          <p style="margin:0;color:#9ca3af;font-size:11px;">Automated reminder generated by <strong><a href="https://codxpert.com/" style="color:#64748b;text-decoration:none;">CodXpert</a></strong> · <a href="https://invoice.codxpert.com" style="color:#64748b;text-decoration:none;">invoice.codxpert.com</a></p>
        </td>
      </tr>
    </table>
  </td></tr>
