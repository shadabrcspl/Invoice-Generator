        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link text-muted" href="{{ route('vs.zoho-invoice') }}">vs Zoho Invoice</a></li>
                    <li class="nav-item"><a class="nav-link active text-dark fw-bold" href="{{ route('vs.tally-prime') }}">vs Tally Prime</a></li>
